...
const WhatsappSidebar = ({ onSelectChat }) => {
    const { contacts, deleteContactById, deleteAllMessagesById } =
...
return (
    <aside className="whatsapp-sidebar">
        ...
        <button
            className="icon-bar-btn notranslate"
            translate="no"
            title="Mi perfil"
        >
                <svg viewBox="0 0 212 212" height="24" width="24">
                    <path
                        fill="currentColor"
                        d="M106 0a106 106 0 1 0 106 106A106 106 0 0 0 106 0Zm0 60a32 32 0 1 1-32 32 32 32 0 0 1 32-32Zm0 120a84 84 0 0 1-59.4-24.6c.4-19.7 39.6-30.5 59.4-30.5s59 10.8 59.4 30.5A84 84 0 0 1 106 180Z"
                    />
                </svg>
            </button>
        </div>
                ...
                <div key={contact.id} className="contact-wrapper">
                    ...
                    <div className="contact-info">
                        <div className="contact-top">
                            ...
                            {contact.last_time || "12:00"}
                            </span>
                        </div>
                            <div className="contact-bottom">
                                <p className="contact-preview">{lastMsg}</p>
                            </div>
                    </div>
                        ...
                        <div className="contact-actions">
                            <button
                                ...
                                e.stopPropagation();
                                setOpenDropdownId(
                                openDropdownId === contact.id ? null : contact.id,
                                );
                            }}
                            title="Opciones"
                            >
